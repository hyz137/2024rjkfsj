            ...
            <div class="nav-wrapper search-bar">
                <form ng-submit="search()" class="ng-pristine ng-invalid ng-invalid-required" action="">
                    <div class="input-field">
                        ...
                        <input type="submit" class="btn"value="搜索" style="background-color: burlywood;margin-bottom: 6px"></input>
                        <label for="search" class="active">
                            <i ng-click="search()" class="iconfont" style="color:burlywood;font-size: 23px"></i>
                        </label>
                    </div>
                </form>
            </div>
                ...
                <c:if test="${empty cur_user}">
                    <li class="publish-btn">
                      <button onclick="showLogin()" data-toggle="tooltip"
                                title="您需要先登录哦！" class="red lighten-1 waves-effect waves-light btn" 	style="background-color: burlywood">
                            我要发布</button>
                    </li>
                </c:if>
                <c:if test="${!empty cur_user}">
                    <li class="publish-btn">
                        <button data-position="bottom" class="red lighten-1 waves-effect waves-light btn" style="background-color: burlywood">
...
<div ng-controller="loginController" class="ng-scope">
    <div id="login-show" class="login stark-components">
        <div class="publish-box z-depth-4" style="background: burlywood">
            <div class="row">
                <a onclick="showLogin()">
...
<div ng-controller="changeNameController" class="ng-scope">
    <div id="changeName" class="change-name stark-components">
        <div class="publish-box z-depth-4" style="background: blanchedalmond">
            <div class="row">
...
<!--
    ...
    描述：左侧导航条
-->
<div ng-controller="sidebarController" class="sidebar stark-components ng-scope" style="height: -webkit-fill-available;background-color: antiquewhite">
