			...
			<!--搜索栏-->
			 <form class="form-horizontal" id="myserchform" name="myform" action="<%=basePath%>admin/searchUser" method="post">
				...
				<div  class="col-sm-8" style="text-align:center;">
					...
					<div class="col-sm-4">
						<button class="btn btn-success btn-sm" type="submit" style="background-color: cadetblue">查找</button>
				...
				<tbody>
					<c:forEach items="${userGrid.rows}" var="item">
						<tr>
							...
							<td>
							<button type="button" class="btn btn-primary btn-sm" onclick="doView(${item.id})" style="background-color: royalblue">查看</button>
							<button type="button" class="btn btn-info btn-sm"  onclick="doEdit(${item.id})" style="background-color: lightseagreen">修改</button>
						</tr>
					</c:forEach>
				</tbody>
			</table>
