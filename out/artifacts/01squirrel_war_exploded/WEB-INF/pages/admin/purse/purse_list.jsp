...
<body>
	...
	<!--=============================================================================================================================================================================-->
	<!--main-container-part-->
	<div id="content" style="margin-right: 100px; margin-top: 40px;background: antiquewhite">
		<!--breadcrumbs-->
		...
		<div class="container" style="width: 1000px;">
			...
			<div class="col-lg-12">
				<h2 class="page-header"
					style="margin-top: 10px; text-align: center; font-family: '微软雅黑', Verdana, sans-serif, '宋体', serif;color: burlywood">
					钱包列表显示</h2>
			</div>
			...
			<form class="form-horizontal" id="myserchform" name="myform"
				...
				<div class="form-group">
					...
					<div class="col-sm-2">
						<button class="btn btn-success btn-default" type="submit" style="background-color: cadetblue">查找</button>
						...
						<tr>
							...
							<c:choose>
							  <c:when test="${item.state==null}">
							   <button type="button" class="btn btn-primary" style="background-color: royalblue">无需审核</button>
							   </c:when>
							   <c:when test="${item.state==0}">
							   <button type="button" class="btn btn-info" onclick="doEdit(${item.id})" style="background-color: royalblue">立即审核</button>
							   </c:when>
							   <c:otherwise>
							   <button type="button" class="btn btn-success" style="background-color: lightseagreen">已经审核</button>
							   </c:otherwise>
							</c:choose>
							</td>
						</tr>
